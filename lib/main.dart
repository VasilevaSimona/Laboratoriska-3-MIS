...
class MainListScreenState extends State<MainListScreen> {
  List<Exam> exams = [
    Exam(course: 'Data Science', timestamp: DateTime(2024, 01, 15,10,30)),
    Exam(course: 'Web Design', timestamp: DateTime(2024, 01, 20,12, 20)),
    Exam(course: 'Data bases', timestamp: DateTime(2024, 01, 22, 11, 00))
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
              ...
              child: const Text('Back to Main Screen', style: TextStyle(color: Colors.pinkAccent),),
            ),
          ],
        ),
      ),
